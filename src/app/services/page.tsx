	...
	return (
		<div className='min-h-screen py-12'>
			...
			<div className="relative w-full h-[200px] mt-20">
				<Image src='https://res.cloudinary.com/duusmu38g/image/upload/v1757449482/z7tk1xr6w5lwt4w6z22s.png' alt='Background Cloud' layout='fill' objectFit='cover' className='brightness-100' priority />
