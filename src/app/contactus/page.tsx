...
const Page = () => {
  return (
    <div className='min-h-screen relative flex items-center py-8 sm:py-16'>
      ...
      <div className='relative z-10 w-full px-4 sm:px-6 lg:px-8 b'>
        <h1 className='text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-center text-background mb-8 sm:mb-12'>"Let's Build Something Great Together"</h1>
        <div className='bg-foreground/20 backdrop-blur-md max-w-xs sm:max-w-lg lg:max-w-3xl xl:max-w-4xl mx-auto p-6 sm:p-8 lg:p-10 rounded-2xl shadow-2xl border border-foreground/10 '>
          ...
          <form action="" className="space-y-4 sm:space-y-6">
            <div>
              <label className='block text-background text-lg font-medium mb-2' htmlFor='email'>Email</label>
              <input className='w-full p-3 sm:p-4 rounded-lg bg-background/80 text-foreground placeholder:text-foreground/60 border border-foreground/20 focus:outline-none focus:ring-2 focus:ring-sky focus:border-sky transition-all duration-200' type='email' id='email' name='email' placeholder='Enter your email' />
            </div>
            <div>
              <label className='block text-background text-lg font-medium mb-2' htmlFor='message'>Message</label>
            ...
            <button type='submit' className='w-full bg-blue-500  text-background font-bold py-3 sm:py-4 px-4 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl'>
        ...
        <div className="max-w-xs sm:max-w-lg lg:max-w-3xl xl:max-w-4xl mx-auto mt-8 backdrop-blur-xl rounded-2xl p-6 sm:p-8">
          ...
          <div className="mt-8 pt-6 border-t border-background/20">
            <div className="text-center">
              <p className="text-background/90 text-lg font-medium mb-4">Follow us on</p>
              <div className="flex justify-center space-x-4">
                <div className="w-12 h-12 bg-background rounded-full flex items-center justify-center hover:scale-110 transition-transform cursor-pointer">
